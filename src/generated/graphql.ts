...
export enum Category {
  Cosmetics = 'COSMETICS',
  CosmicArtifacts = 'COSMIC_ARTIFACTS',
  Fashion = 'FASHION',
...
export type GetProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, title: string, brand: string, price: number, description: string, imageUrl: string, reviews: { __typename?: 'Reviews', totalCount: number, rating: number, scoreDistribution: Array<{ __typename?: 'ScoreCount', score: number, count: number }> } } | null };

export type GetProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, title: string, price: number, imageUrl: string, category: Category, brand: string }> };
